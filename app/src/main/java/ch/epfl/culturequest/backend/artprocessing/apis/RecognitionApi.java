...
public class RecognitionApi {
    ...
    private CompletableFuture<ArtRecognition> getArtFromParsing(CompletableFuture<String> responseBody){
        Pattern patternArt = Pattern.compile("(?<=\\[\")([a-zàâçéèêëîïôûùüÿñæœ -]*)(?=\",\"((?:monument|peinture|painting|sculpture|photo|historical|appartment|apartment|building|landmark|landmarks|landscape|paint|statue|bridge)[a-zàâçéèêëîïôûùüÿñæœ -]*)\")", Pattern.CASE_INSENSITIVE);
